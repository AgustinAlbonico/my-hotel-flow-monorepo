              ...
              filteredActions.map((action) => (
                <tr key={action.id} className="hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors">
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div className="text-sm font-medium text-gray-900 dark:text-gray-100">{action.name}</div>
                    {action.description && (
                    ...
                    <div className="flex items-center justify-end gap-2">
                      ...
                      <Can perform="config.acciones.eliminar">
                        <button
                          ...
                          className="text-error-600 hover:text-error-900 transition-colors disabled:opacity-50"
