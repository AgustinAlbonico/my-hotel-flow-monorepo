 ...
 * DTO de presentación para asignar acciones a un grupo
 */
...
export class AssignActionsRequestDto {
  @ApiProperty({
    description: 'Array of action IDs to assign to the group',
    example: [1, 2, 3],
    type: [Number],
    required: false,
  })
  ...
  @ApiProperty({
    description:
      'Array of action keys to assign to the group (alternative to actionIds)',
