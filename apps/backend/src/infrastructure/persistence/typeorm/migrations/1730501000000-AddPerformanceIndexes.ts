...
export class AddPerformanceIndexes1730501000000 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    // Nota: Removido CONCURRENTLY porque no puede ejecutarse dentro de una transacción
    ...
    await queryRunner.query(`
      CREATE INDEX IF NOT EXISTS idx_reservations_dates_brin
    ...
    await queryRunner.query(`
      CREATE INDEX IF NOT EXISTS idx_rooms_type_active
